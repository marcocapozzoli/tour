from app.controller import CompanyController, DepartmentController, EmployeeController
...
def controller_factory(factory) -> CompanyController | DepartmentController | EmployeeController:
